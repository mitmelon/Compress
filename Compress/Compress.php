...
class Compress{
     ...
     */
    public function compressor(String $content)
    {
   ...
   /**
     ...
     * @param String $content
     */
    public function uncompressor(String $content)
    {
   ...
   /**
     ...
     */
    public function uncompressFile($fileInputPath, $fileOutputPath, $encrypt_key = null)
    {
        try {
